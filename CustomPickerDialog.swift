...
class CustomPickerDialog: UIView, UIPickerViewDelegate {
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width:
            300,
                                height: 230
                                    + kPickerDialogDefaultButtonHeight + kPickerDialogDefaultButtonSpacerHeight)
        ...
        self.picker.setValue(UIColor.init(hexString: "333333"), forKeyPath: "textColor")
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor.init(hexString: "555555"), for: UIControlState.normal)
        ...
        self.doneButton.setTitleColor(UIColor.init(hexString: "555555"), for: UIControlState.normal)
